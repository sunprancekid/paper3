...
program conH_init
    ...
    read (args(7), '(f6.4)') init_temperature ! temperature is a real number greater than 0
    read (args(8), *) events ! second argument is the number of simulation events
    read (args(9), '(f6.4)') annealing_fraction ! annealing fraction is a real number between 0 and 1
